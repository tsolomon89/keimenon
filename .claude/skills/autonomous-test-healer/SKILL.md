...
```json
{
  "healing_session": {
    ...
    "still_failing": 2,
    "duration_minutes": 15,
    "visual_evidence_dir": ".claude/healing-sessions/2025-11-01-120000/"
  },
  "fixes_applied": [
    {
...
```html
<!-- Generated at: .claude/healing-sessions/2025-11-01-120000/report.html -->
...
- Healing history tracked in `.claude/healing-history.json`
- **📸 Visual evidence stored in** `.claude/healing-sessions/YYYY-MM-DD-HHMMSS/`
