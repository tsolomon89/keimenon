...
**Date**: 2025-11-22
**Benchmark Suite**: [apps/api/src/__tests__/duplicate-detection-benchmark.test.ts](apps/api/src/__tests__/duplicate-detection-benchmark.test.ts)
...
for (let i = 0; i < allMessages.length; i++) {
  for (let j = i + 1; j < allMessages.length; j++) {  // ❌ O(n²)
...
- **Benchmark Test**: [apps/api/src/__tests__/duplicate-detection-benchmark.test.ts](apps/api/src/__tests__/duplicate-detection-benchmark.test.ts)
- **Service Under Test**: [apps/api/src/services/duplicate-detection.ts](apps/api/src/services/duplicate-detection.ts)
- **Integration Test**: [apps/api/src/__tests__/duplicate-detection-integration.test.ts](apps/api/src/__tests__/duplicate-detection-integration.test.ts)
