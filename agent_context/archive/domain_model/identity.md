...
> **Invariant**: Identity is hierarchical. A User exists _within_ a Tenant context for most operations ("Member"), but has a global existence for Authentication ("Principal").
