...
exports.PublishableExport = void 0;
exports.createPublishableExport = createPublishableExport;
 ...
 */
class PublishableExport {
    constructor(db, policy, snapshotsDir = './exports/snapshots') {
        this.db = db;
        this.policy = policy;
     ...
     */
    exportEdgesOnly(options = {}) {
        const { minScore = 0, includeReasonCodes = this.policy.publishing.edges_only.include_reason_codes, includeLevelModality = true, } = options;
     ...
     */
    saveSnapshot(snapshot, customPath) {
     ...
     */
    compareSnapshots(version1, version2) {
...
exports.PublishableExport = PublishableExport;
/**
 * Helper: Create publishable export service
 */
function createPublishableExport(db, policy, snapshotsDir) {
    return new PublishableExport(db, policy, snapshotsDir);
}
//# sourceMappingURL=publishable-export.js.map