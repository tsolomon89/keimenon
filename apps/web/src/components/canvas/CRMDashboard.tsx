...
function MetricCard({ title, value, subtitle, icon: Icon, trend, color = 'slate' }: MetricCardProps) {
  const colorClasses = {
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 capitalize">{account.account_class}</p>
                      </div>
                    </div>
                    <span className="text-sm text-slate-400">
                      {account.activity_count || account.node_count || 0} {account.activity_count ? 'actions' : 'nodes'}
                    </span>
                  </div>
                ))}
              </div>
