 ...
 *
 * Extracted from SettingsCard.tsx lines 227-512
 * Preserves exact visual design while making it reusable
 *
 * Features:
 ...
 * ```tsx
 * // Boolean toggle
 * <Field type="boolean" label="Enabled" value={enabled} onChange={setEnabled} />
 *
 * // Text input
 * <Field type="string" label="Name" value={name} onChange={setName} />
 *
 * // Read-only value
 * <Field type="string" label="Account ID" value={id} mode="read" />
 * ```
 */
 ...
 * Extracted from SettingsCard.tsx control implementations
 */
...
// Control components extracted from SettingsCard.tsx lines 227-512
