...
claude mcp add --scope user --transport stdio keimenon-database --env SQLITE_PATH=%USERPROFILE%\.keimenon\keimenon.db -- node "%PROJECT_ROOT%\.mcp\servers\database\index.js"
...
claude mcp add --scope user --transport stdio keimenon-settings-crm --env SQLITE_PATH=%USERPROFILE%\.keimenon\keimenon.db -- node "%PROJECT_ROOT%\.mcp\servers\settings-crm\index.js"
