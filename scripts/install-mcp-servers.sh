...
claude mcp add --scope user --transport stdio keimenon-database --env SQLITE_PATH="$HOME/.keimenon/keimenon.db" -- node C:/Development/Projects/ai_convo_parser/.mcp/servers/database/index.js
...
claude mcp add --scope user --transport stdio keimenon-settings-crm --env SQLITE_PATH="$HOME/.keimenon/keimenon.db" -- node C:/Development/Projects/ai_convo_parser/.mcp/servers/settings-crm/index.js
